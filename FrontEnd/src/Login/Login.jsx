...
function Login() {
  ...
  function pass() {
    //showing error message in all cases of invalid password
  ...
  function confirm() {
    //showing error message if the passwords do not match
    if (!validateConfirm()) {
      $(".error2").addClass("ShowError");
  ...
  function continueBttn() {
    //diabling the sign up button if there is an error
  ...
  function validatePass() {
    //checking the length of the password>8
  ...
  function digitsAndChar() {
    //checking that password has at least 1 digit and 1 char
    var pass = $("#pwd").val(); //getting the value of the password to check the charachers
  ...
  function validateConfirm() {
    //checking if confirm password an password match
    var pass = $("#pwd").val();
    ...
    <>
      <div className="TotalPage">
        <Link className="skipLink" style={navStyle} to={`/`}>
          <button type="submit" className="skipButton">
            SKIP
          </button>
        </Link>
        <div id="frame" className="form-box">
          <div className="FormType-button">
            ...
            <button type="button" className="ToggleForm" onClick={SIGN}>
              LOG IN
            </button>
            <button type="button" className="ToggleForm" onClick={SIGN}>
              SIGN UP
          ...
          <form className="inputGroupSignUp">
            ...
            />
            <p className="error1">
              Password needs to be more then 8 characters{" "}
            </p>
            <p className="error4">
              Password should contain 1 charachter and 1 digit
            </p>
            <input
              type="password"
              className="input_field"
